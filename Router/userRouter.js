...
const { register, login, verify, reSendOtp, googleRegister, googleLogin, getUser, alluser, sendEmail, optValid, changePassword, adminlogin } = require("../Controller/userController");
